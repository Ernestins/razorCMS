...
<html xmlns:ng="http://angularjs.org">
	<head>
		...
		<!-- require js -->
		<script <?php $this->data_main() ?> src="<?php echo RAZOR_BASE_URL ?>assets/js/require.js"></script>
		<script src="<?php echo RAZOR_BASE_URL ?>assets/js/require-config.js"></script>

		<!-- load bootstrap, style overrides and public css -->
		<link type="text/css" rel="stylesheet" href="<?php echo RAZOR_BASE_URL ?>assets/style/razor/razor_base.css">
		<!--[if IE 9]><link type="text/css" rel="stylesheet" href="<?php echo RAZOR_BASE_URL ?>assets/style/razor/razor_base_ie9.css"><![endif]-->
		<!--[if IE 8]><link type="text/css" rel="stylesheet" href="<?php echo RAZOR_BASE_URL ?>assets/style/razor/razor_base_ie8.css"><![endif]-->

		<link type="text/css" rel="stylesheet" href="<?php echo RAZOR_BASE_URL ?>theme/style/default/default.css">
		<!--[if IE 9]><link type="text/css" rel="stylesheet" href="<?php echo RAZOR_BASE_URL ?>theme/style/default/default_ie9.css"><![endif]-->
		<!--[if IE 8]><link type="text/css" rel="stylesheet" href="<?php echo RAZOR_BASE_URL ?>theme/style/default/default_ie8.css"><![endif]-->

		<link rel="shortcut icon" href="<?php echo RAZOR_BASE_URL ?>assets/images/favicon.ico" type="image/x-icon">
	</head>
