...
<html xmlns:ng="http://angularjs.org">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="<?php echo RAZOR_BASE_URL ?>assets/style/default/default.css">
		<!--[if IE 9]><link type="text/css" rel="stylesheet" href="<?php echo RAZOR_BASE_URL ?>assets/style/default/default_ie9.css"><![endif]-->
		<!--[if IE 8]><link type="text/css" rel="stylesheet" href="<?php echo RAZOR_BASE_URL ?>assets/style/default/default_ie8.css"><![endif]-->

		<link rel="shortcut icon" href="<?php echo RAZOR_BASE_URL ?>favicon.ico" type="image/x-icon">
	</head>
