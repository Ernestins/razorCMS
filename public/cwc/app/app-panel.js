    ...
    static template() {
        return html`
            <style>
				...
				.dashboard-controls .rotate-icon { cursor: pointer; position: absolute; top: 5px; left: 5px; width: 15px; height: 15px; }
				.dashboard-controls .details { padding-left: 20px; float: right; text-align: right; }
				.dashboard-controls .details .name { font-size: 16px; }
				.dashboard-controls .details .name .profile-icon { display: inline-block; width: 30px; height: 30px; vertical-align: middle; cursor: pointer; }
				.dashboard-controls .details .last-logged-in .logged-in-date { font-size: 14px; }
				.dashboard-controls .details .last-logged-in .history-icon { display: inline-block; height: 16px; width: 16px; vertical-align: text-top; }
				.editor-controls { float: left; width: 100%; }
				.editor-controls .setting-icon { display: inline-block; width: 32px; height: 32px; cursor: pointer; vertical-align: middle; }
				.editor-controls .setting-button { vertical-align: middle; float: right; width: auto; margin-left: 7px; }
				.editor-controls .setting-edit { background-color: green; color: white; }
				.editor-controls .setting-add { background-color: #0b56b4; color: white; }
				.editor-controls .setting-copy { background-color: #0b56b4; color: white; }
			</style>
