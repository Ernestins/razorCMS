	...
	static template() {
		return html`
			<style>
				...
				.page-box .page-box-col { display: block; flex: 1 1 350px; padding: 10px; box-sizing: border-box; }
				.page-box .page-title { font-size: 30px; margin: 0px; padding: 0px; }
				.page-box .page-description { height: 150px; }
				.page-box .page-cancel { background-color: #cd1918; color: white; float: left; padding: 6px 16px; }
